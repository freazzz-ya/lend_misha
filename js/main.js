...
const swiperHero = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](".hero__slider", {
  slidesPerView: 1,
  spaceBetween: 10,
  pagination: {
    el: ".hero__slider .slider__pagination",
    clickable: true
  },
  breakpoints: {
    1440: {
...
const swiperHistory = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](".history__slider", {
  slidesPerView: 1,
  spaceBetween: 10,
  pagination: {
    el: ".history__slider .slider__pagination",
    clickable: true
  },
  breakpoints: {
    1440: {
...
const popupCloseIcon = document.querySelectorAll(".close__btn");
...
formBtn?.addEventListener("click", e => {
  ...
  if (!ValidateEmpty(inputPolis.value)) {
    ...
    if (ValidatePolis(inputPolis.value)) {
      ...
      inputPolis.nextElementSibling.classList.add("_visible");
      formBtn.nextElementSibling.classList.add("_visible");
      inputPolis.nextElementSibling.textContent = "Неверный формат";
      errors[0] = true;
    }
  } else {
    inputPolis.nextElementSibling.classList.add("_visible");
    inputPolis.nextElementSibling.textContent = "Пожалуйста, заполните это поле.";
    errors[0] = true;
  }
  if (!ValidateEmpty(inputDate.value)) {
    inputDate.nextElementSibling.classList.remove("_visible");
    if (ValidateLength(10, inputDate.value)) {
      inputDate.nextElementSibling.classList.remove("_visible");
      if (ValidateDate(inputDate.value) >= 0) {
        inputDate.nextElementSibling.classList.remove("_visible");
        errors[1] = false;
      } else {
        inputDate.nextElementSibling.classList.add("_visible");
        inputDate.nextElementSibling.textContent = "Указана дата, которая не допускается";
        errors[1] = true;
      }
    } else {
      inputDate.nextElementSibling.classList.add("_visible");
      inputDate.nextElementSibling.textContent = "Неверный формат";
      errors[1] = true;
    }
  } else {
    inputDate.nextElementSibling.classList.add("_visible");
    inputDate.nextElementSibling.textContent = "Пожалуйста, заполните это поле.";
    errors[1] = true;
  }
...
(function (global, factory) {
  typeof exports === "object" && "object" !== "undefined" ? module.exports = factory() : typeof define === "function" && __webpack_require__.amdO ? define(factory) : (global = global || self, global.IMask = factory());
})(undefined, function () {
  "use strict";
